...
MAND_SRCS 	= ast/ast_split.c ast/ast.c ast/prepare_ast.c \
			...
			parser/parser_tkn_list_utils.c parser/parser_utils.c parser/parser_utils_2.c parser/parser.c \
			parser/tokenizer_utils.c parser/tokenizer.c redirects/heredoc.c redirects/heredoc_utils.c redirects/heredoc_utils2.c \
			redirects/redirects.c redirects/verify_permissions.c redirects/backup_and_restore.c utils/minishell_utils.c minishell.c \
			prompt.c utils/cleaners.c signals/signals.c signals/signals_utils.c
