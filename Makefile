...
MAND_SRCS 	= 	ast/ast.c ast/ast_split.c \
				...
				execution/find_path.c execution/init.c execution/prepare_exec.c execution/multi_exec_cmds.c \
				execution/multi_exec_cmds_utils.c execution/check_builtins.c redirects/handle_redirects.c \
