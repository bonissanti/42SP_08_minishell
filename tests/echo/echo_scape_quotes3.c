...
MU_TEST(echo_2arg_to_file)
{
    ...
    pid = fork();
	system("echo \\\"'$USER' > ./txts/echo_scape_quotes3.txt");
    ...
    send_command_and_write_to_file("echo \\\"'$USER'", "./txts/echo_scape_quotes3_minishell.txt");
    compare_files("./txts/echo_scape_quotes3_minishell.txt", "./txts/echo_scape_quotes3_bash.txt");
}
