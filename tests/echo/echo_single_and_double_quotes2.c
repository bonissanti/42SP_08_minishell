...
MU_TEST(echo_2arg_to_file)
{
    ...
    pid = fork();
	system("echo '\"$USER\"' > ./txts/echo_single_and_double_quotes2.txt");
    ...
    send_command_and_write_to_file("echo '\"$USER\"'", "./txts/echo_single_and_double_quotes2_minishell.txt");
    compare_files("./txts/echo_single_and_double_quotes2_minishell.txt", "./txts/echo_single_and_double_quotes2_bash.txt");
}
