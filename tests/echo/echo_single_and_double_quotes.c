...
MU_TEST(echo_2arg_to_file)
{
    ...
    pid = fork();
	system("echo \"'$USER'\" > ./txts/echo_single_and_double_quotes.txt");
    ...
    send_command_and_write_to_file("echo \"'$USER'\"", "./txts/echo_single_and_double_quotes_minishell.txt");
    compare_files("./txts/echo_single_and_double_quotes_minishell.txt", "./txts/echo_single_and_double_quotes_bash.txt");
}
