...
MU_TEST(echo_2arg_to_file)
{
    ...
    pid = fork();
	system("echo '$USER' > ./txts/echo_expand_var_single_quotes.txt");
    ...
    send_command_and_write_to_file("echo '$USER'", "./txts/echo_expand_var_single_quotes_minishell.txt");
    compare_files("./txts/echo_expand_var_single_quotes_minishell.txt", "./txts/echo_expand_var_single_quotes_bash.txt");
}
