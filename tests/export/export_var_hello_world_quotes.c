...
MU_TEST(test_export)
{
    ...
    pid = fork();
	system("export hello=\"world\" > ./txts/export_var_hello_world_quotes_minishell.txt");
    ...
    send_command_and_write_to_file("export  hello=\"world\"", "./txts/export_var_hello_world_quotes_minishell.txt");
    compare_files("./txts/export_var_hello_world_quotes_minishell.txt", "./txts/export_var_hello_world_quotes_bash.txt");
}
