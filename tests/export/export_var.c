...
MU_TEST(test_export)
{
    ...
    pid = fork();
	system("export VAR= > ./txts/outfile_bash.txt");
    ...
    send_command_and_write_to_file("export VAR=", "./txts/outfile_minishell.txt");
    compare_files("./txts/outfile_minishell.txt", "./txts/outfile_bash.txt");
}
