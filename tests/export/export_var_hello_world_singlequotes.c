...
MU_TEST(test_export)
{
    ...
    pid = fork();
	system("export hello='world' > ./txts/export_var_hello_world_singlequotes_minishell.txt");
    ...
    send_command_and_write_to_file("export  hello='world'", "./txts/export_var_hello_world_singlequotes_minishell.txt");
    compare_files("./txts/export_var_hello_world_singlequotes_minishell.txt", "./txts/export_var_hello_world_singlequotes_bash.txt");
}
