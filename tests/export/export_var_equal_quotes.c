...
MU_TEST(test_export)
{
    ...
    pid = fork();
	system("export VAR=\"\" > ./txts/export_var_equal_quotes_minishell.txt");
    ...
    send_command_and_write_to_file("export VAR=\"\"", "./txts/export_var_equal_quotes_minishell.txt");
    compare_files("./txts/export_var_equal_quotes_minishell.txt", "./txts/export_var_equal_quotes_bash.txt");
}
